...
<div id="wrapper">
	     ...
	     <div class="xs">
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form action = "submitBill.jsp" method = "post" class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Bill Id</label>
									<div class="col-sm-8">
										<input type="text" name="aid" class="form-control1" id="focusedinput" placeholder="Enter Bill Id">
									</div>				
	...
	<center><button class="btn-success btn">Submit Bill</button></center>
	</form>     
